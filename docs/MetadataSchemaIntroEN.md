...
0. **Technical metadata**  
  ...
  See: [`Technical metadata.md`](Schema_0EN.md)
...
1. **Study related information**  
  ...
  See: [`Study related information`](Schema_1EN.md)
...
2. **Administrative information**  
  ...
  See: [`Administrative information`](Schema_2EN.md)
...
3. **Study methodology**  
  ...
  See: [`Study methodology`](Schema_3EN.md)
...
4. **Data collection and access**  
  ...
  See: [`Data collection and access`](Schema_4EN.md)
