...
# Interventional Study : Intervention model
...
>_Download in **[`XML/RDF`](https://github.com/portail-fresh/fresh-metadata-schema/blob/main/ControlledVocabularies/InterventionalStudyModel.rdf)**_
