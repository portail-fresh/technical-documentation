...
>_S'applique pour l'élément **[`DocumentType`](../DictionnaireVariables/Section_4.md)**_  

>_Télécharger au format **[`XML/RDF`](https://github.com/portail-fresh/fresh-metadata-schema/blob/main/ControlledVocabularies/DocumentType.rdf)**_    
...
<table>
  ...
  <tr>
    <td>Publication définissant la base de données et/ou son protocole de collecte (article présentant les données, profil de la cohorte, article sur la méthode ou le protocole, article de synthèse, note sur les données, rapport enregistré...).</td>
